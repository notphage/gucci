...
public:
	static void MD5Init(MD5Context_t* context);
	static void MD5Update(MD5Context_t* context, unsigned char const* buf, unsigned int len);
	static void MD5Final(unsigned char digest[16], MD5Context_t* context);

	static unsigned int MD5_PseudoRandom(unsigned int nSeed);
};
...
// Input  : *ctx - 
//-----------------------------------------------------------------------------
inline void C_MD5::MD5Init(MD5Context_t* ctx)
{
...
//			len - 
//-----------------------------------------------------------------------------
inline void C_MD5::MD5Update(MD5Context_t* ctx, unsigned char const* buf, unsigned int len)
{
	unsigned int t;
...
//			*ctx - 
//-----------------------------------------------------------------------------
inline void C_MD5::MD5Final(unsigned char digest[16], MD5Context_t* ctx)
{
	unsigned count;
	unsigned char* p;
...
//-----------------------------------------------------------------------------
inline unsigned int C_MD5::MD5_PseudoRandom(unsigned int nSeed)
{
	MD5Context_t ctx;
